...
MAX_ARCHIVE_ITEMS = _env_int("opanel_ent_MAX_ARCHIVE_ITEMS", 1_000_000)
MAX_ARCHIVE_UNCOMPRESSED_BYTES = _env_int("opanel_ent_MAX_ARCHIVE_UNCOMPRESSED_BYTES", 100 * 1024 * 1024 * 1024)
...
def _assert_tree_write_allowed(
    ...
    if path.is_dir():
        try:
            ...
            # OPanel Enterprise process may not have read access into site-user directories.
