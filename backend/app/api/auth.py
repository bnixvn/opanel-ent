...
SESSION_COOKIE = "opanel_ent_session"
CSRF_COOKIE = "opanel_ent_csrf"
...
_DUMMY_HASH = hash_password("not-a-real-password-opanel-ent-dummy")
...
def _rate_limit_key(kind: str, key: str) -> str:
    return f"opanel-ent:login:{kind}:{key}"
...
def _log_redis_fallback(exc: Exception) -> None:
    ...
    logging.getLogger("opanel-ent.auth").warning(
